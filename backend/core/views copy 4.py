...
def home_zh(request):
    ctx = {"meta": _meta_for("zh", request), "wallet_user": get_wallet_user(request)}
    return render(request, "home.html", ctx)
...
def rewards_zh(request):
    ctx = {"meta": _meta_for("zh", request, page="rewards"), "lang": "zh", "wallet_user": get_wallet_user(request)}
    return render(request, "rewards.html", ctx)
...
def events_zh(request):
    return render(request, "events.html", {"meta": _meta_for_events("zh", request), "wallet_user": get_wallet_user(request)})
