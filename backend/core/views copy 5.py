...
def rewards_en(request):
    ...
    ctx = {
        ...
        "projects": projects,   # <-- what rewards.html iterates
    }
...
def rewards_apply_submit(request):
    """
    Accepts form submission from rewards_apply.html and creates CampaignApplication.
    Accepts the fields from your new models; any missing optional fields default safely.
    """
    data = request.POST
